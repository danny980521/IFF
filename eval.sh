...
MODEL_PATH="${1:-"/data/ib-a100-cluster-a-pri-lmt_967/users/wavy/workspace/study/alignment/IFF/checkpoints/dpo-from-1693-steps-merged/checkpoint-630"}"
MODEL_ID="${2:-"kanana-nano-2.1b-base+sft-1epoch+dpo-merged-3epoch"}"
TENSOR_PARALLEL_SIZE="${3:-1}"
DATA_PARALLEL_SIZE="${4:-8}"
JUDGE_MODEL_PATH="${5:-"/data/ib-a100-cluster-a-pri-lmt_967/users/wavy/workspace/study/models/Qwen2.5-32B-Instruct"}"
JUDGE_MODEL_ID="${6:-"Qwen2.5-32B-Instruct"}"
JUDGE_MODEL_TP_SIZE="${7:-8}"
HF_DATASETS_CACHE="${8:-"/data/ib-a100-cluster-a-pri-lmt_967/users/wavy/ds_cache"}"
